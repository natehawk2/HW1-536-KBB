...
Model: $y_i$ = $\beta_0$ + $\beta_1$$x_{i1}$ +  $\beta_2$$x_{i2}$ + $\beta_3$$x_{i3}$ + $\beta_4$$x_{i1}$$x_{i2}$ + $\beta_5$$x_{i1}$$x_{i3}$ + $\epsilon_i$ or

$y_i$ = $\beta_0$ + $\beta_1$Mileage +  $\beta_2$I(group = Buick) * Mileage +  $\beta_2$I(group = Cadillac) * Mileage + $\beta_3$I(group = OECD) + $\beta_4$log(PPGDP) * I(group = Africa) + $\beta_5$log(PPGDP) * I(group = OECD) + $\epsilon_i$
